import { Body, Column, Container, Head, Html, Img, Link, Row, Section, Tailwind, Text } from "@react-email/components";


export default function EmailWrapper({ children }: { children: React.ReactNode }) {
        ...
        >
            <Body className="bg-white my-auto mx-auto font-sans px-2">
                <Container className="border border-solid border-[#eaeaea] rounded my-[40px] mx-auto p-[20px] max-w-[465px]">
                    ...
                    <Container className="px-[32px] py-[40px]">
                        {children}
                    </Container>
