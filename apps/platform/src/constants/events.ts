...
export const rawEventsSchema = z.object({
    title: z.string().min(1, "Name is required").min(3, "Name must be at least 3 characters long")
    .max(100, "Name must be at most 100 characters long (enter description instead)"), // Name of the event
