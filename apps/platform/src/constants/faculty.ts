...
export const FACULTY_LIST:FacultyType[] = [
  {
  ...
  {
    "name": "Dr. Siddhartha Chauhan (HoD)",
  ...
  {
    "name": "Dr. Pushpendra Singh (on lien)",
    "email": "spushp@nith.ac.in",
    "department": "Electronics and Communication Engineering"
  },
  {
