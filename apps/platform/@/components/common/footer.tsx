...
export default function Footer() {
  return (
    <footer className="z-50 max-w-7xl mx-auto inset-inline-0 flex w-full items-center justify-around font-bold p-4 lg:py-2 backdrop-blur-2xl ">
      <Link
        href="/"
      ...
      <div className="items-center gap-5 flex">
        ...
        <Link
          ...
          className={
            " hover:text-primary hover:-translate-y-1 ease-in duration-300 flex justify-center items-center h-8 icon"
          }
        >
        ...
        <Link
          ...
          className={
            " hover:text-primary hover:-translate-y-1  ease-in duration-300 flex justify-center items-center h-16 icon"
          }
        >
