...
import { AlertTriangle, ArrowLeft, Home, Lock, LogIn, Shield } from "lucide-react"
        ...
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-amber-25 to-orange-25">
            <Card className="w-full max-w-md text-center border-amber-100 shadow-lg">
                ...
                <CardContent className="space-y-4">
                    ...
                    <div className="flex flex-col gap-3">
                        <ButtonLink className="bg-amber-500 hover:bg-amber-600 text-white" href="/auth/sign-in">
                                <LogIn />
                                Log In
                        </ButtonLink>
                    ...
                    <div className="pt-4 border-t border-amber-100">
                        <p className="text-xs text-amber-500">
                            ...
                            <Link href="/auth/sign-in" className="ml-1 underline hover:text-amber-700">
                                Sign up here
                            </Link>
                        </p>
                    </div>
