...
const inputVariants = cva(
  "flex h-10 w-full rounded-md bg-input px-3 py-2 text-sm font-medium file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground focus-visible:outline-none disabled:cursor-not-allowed disabled:opacity-50 disabled:border-input disabled:bg-input invalid:ring-red-500 border-input",
  {
    variants: {
      variant: {
