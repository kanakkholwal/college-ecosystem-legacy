...
const VercelTabsList = React.forwardRef<HTMLDivElement, TabsProps>(
    ({ className, tabs, activeTab, onTabChange, onTabChangeQuery, triggerHeight = "h-[30px]", ...props }, ref) => {
        ...
        return (
            <div
                ...
                ref={ref} {...props}>
                    <div
                        className={cn("absolute transition-all duration-300 ease-out bg-card rounded-xl flex items-center", triggerHeight)}
                        style={{
                            ...hoverStyle,
