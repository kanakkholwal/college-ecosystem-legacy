...
const textareaVariants = cva(
  "flex min-h-[80px] w-full rounded-md border border-input bg-card px-3 py-2 text-sm font-medium ring-offset-background placeholder:text-muted-foreground  focus-visible:outline-none focus-visible:border-primary/80 disabled:cursor-not-allowed disabled:opacity-50",
  {
    variants: {
      variant: {
