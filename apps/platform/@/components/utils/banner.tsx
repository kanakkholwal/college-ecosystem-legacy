...
export function BannerPanel({ className, description, title, btnProps }: BannerPanelProps) {


    return (
        <div className={cn("bg-muted px-4 py-3 md:py-2 rounded-lg max-w-max mx-auto relative", className)}>
