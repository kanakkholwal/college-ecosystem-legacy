...
function BaseHeroSection(props: BaseHeroSectionProps) {
    return <section
        ...
        style={props.style}
    >
        <h2 className={cn("mb-2 text-2xl lg:text-4xl font-semibold text-center text-pretty md:whitespace-nowrap bg-gradient-to-r bg-clip-text text-transparent  from-primary to-sky-500  hover:from-sky-500 hover:to-primary", props.titleClassName)}>
            {props.title}
        </h2>
        <p className={cn("text-base text-muted-foreground text-pretty max-w-4xl mx-auto", props.descriptionClassName)}>
            {props.description}
        </p>
        <div
