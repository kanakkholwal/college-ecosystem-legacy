...
export function ActionBar<T>({ className, title, description, btnProps, action }: ActionBarProps<T>) {
    ...
    return (
        <div className={cn("flex justify-between items-center w-full p-1", className)}>
