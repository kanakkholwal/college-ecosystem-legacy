          ...
          <div className="min-h-screen w-full relative overflow-hidden">
            <nav className="flex justify-between items-center w-full py-3 px-4 md:px-6">
              <Link href="/" aria-label="logo" className="p-1.5">
                ...
                <Image
                  height={40}
                  width={280}
                  className="h-12 dark:invert w-auto"
                  src="/assets/logo.svg"
                  alt="logo"
                />
              </Link>
              ...
              <Link
                href="/contact"
                className="flex items-center gap-2 text-slate-700 dark:text-slate-400 hover:underline text-base"
              >
            ...
            <div className="flex flex-col justify-center items-center p-4 w-full h-full gap-4 mt-10">
              ...
              <div className="mt-4 flex justify-center items-center flex-wrap gap-5">
                <ButtonLink size="lg" variant="light" href="/">
                  Go to Home
                </ButtonLink>
                <Button
                  size="lg"
