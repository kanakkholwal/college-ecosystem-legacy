    ...
    return <>
        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4">
            <div className="bg-white/20 backdrop-blur-lg p-4 rounded-lg shadow-md">
                ...
                <h3 className="text-primary font-bold tracking-wide text-3xl mt-4">{basicInfo.counts.results}</h3>
            </div>
            <div className="bg-white/20 backdrop-blur-lg p-4 rounded-lg shadow-md">
                <h4 className="text-lg font-bold">Total Branches</h4>
                <h3 className="text-primary font-bold tracking-wide text-3xl mt-4">{basicInfo.counts.branches}</h3>
            </div>
            <div className="bg-white/20 backdrop-blur-lg p-4 rounded-lg shadow-md">
                <h4 className="text-lg font-bold">Total Batches</h4>
                <h3 className="text-primary font-bold tracking-wide text-3xl mt-4">{basicInfo.counts.batches}</h3>
            </div>
        </div>
        <Tabs defaultValue="scrape" className="w-full">
            <TabsList className="w-full h-14 px-2 gap-2">
                <TabsTrigger value="scrape" className="text-md w-full">Scrape Results</TabsTrigger>
                <TabsTrigger value="rank" className="text-md w-full">Rank Results</TabsTrigger>
            </TabsList>
