...
export default function DashboardPage(props: PageProps) {
  ...
  useEffect(() => {
    const query = {
      searchField: (searchParams.get("searchField") as "email" | "name") || "email",
      searchOperator: (searchParams.get("searchOperator") as "contains" | "starts_with" | "ends_with") || "ends_with",
      searchValue: searchParams.get("searchValue") || "@nith.ac.in",
