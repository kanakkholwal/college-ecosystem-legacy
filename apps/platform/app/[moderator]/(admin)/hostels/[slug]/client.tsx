                ...
                <div className="grid grid-cols-1 gap-3">
                    ...
                    <div className="flex items-center justify-start gap-3 w-full">
                        {form.watch("students").map((student, index) => {
                            ...
                            return (
                                <div key={student} className="inline-flex justify-start items-start gap-2">
                                    <div className="inline-flex justify-start items-center space-x-2">
                                        <div>
                                            {student}
                                        </div>
                                        <Button type="button" size="icon_sm" variant="destructive_light" onClick={() => {
                                            form.setValue("students", form.watch("students").filter((_, i) => i !== index))
                                        }}>
                                            <X />
                                        </Button>
                                    </div>
