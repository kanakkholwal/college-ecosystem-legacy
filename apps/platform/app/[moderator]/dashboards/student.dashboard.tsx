...
export default async function StudentDashboard({ role }: { role: string }) {
  ...
  return (
    <div className="space-y-6 my-5">
      <NoteSeparator label="Academics and Hostel Information" className="p-0" />
      <ResponsiveContainer className="w-full @5xl:grid-cols-3 pr-1.5 @4xl:pr-0">
        ...
        {dashboardData.hosteler && (
          <StatsCard title="Outpass Issued">
            <NumberTicker
      ...
      <NoteSeparator label="Platform Activities" className="p-0" />
      <ResponsiveContainer className="w-full @5xl:grid-cols-3 pr-1.5 @4xl:pr-0">
        {/* <StatsCard
        ...
        <StatsCard title="Total Community Posts">
          <NumberTicker
        ...
        <StatsCard title="Total Community Comments">
          <NumberTicker
            value={
              dashboardData.platformActivities?.communityCommentsCount || 0
            }
            className="text-3xl font-bold text-primary"
          />
          <p className="text-xs text-muted-foreground">
        ...
        <StatsCard title="Total Polls Created">
          <NumberTicker
      ...
      <NoteSeparator label="Platform Quick Links" className="p-0" />
