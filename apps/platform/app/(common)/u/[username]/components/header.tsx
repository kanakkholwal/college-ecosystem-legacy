...
export function ProfileHeader({ user, authenticated, isCurrentUser }: ProfileHeaderProps) {
                ...
                <div className="flex flex-col lg:flex-row gap-6">
                    ...
                    <div className="flex flex-col items-center lg:items-start">
                        ...
                        <div className="mt-4 text-center lg:text-left">
                            ...
                            <p className="text-muted-foreground text-base mb-3">{user.department} {isValidRollNumber(user.username) ? `- ${getAcademicYear(user.username).label}` : null}</p>
                            ...
                            <div className="flex flex-col gap-2 text-sm text-muted-foreground">
                                <div className="flex items-center gap-2">
                                    ...
                                    <span>
                                        {authenticated ? user.hostelId ? changeCase(user.hostelId.replace("_", " "), "title") + ", " : null : null}
                                        {orgConfig.name}
                                    </span>
                                </div>
                                <div className="flex items-center gap-2">
