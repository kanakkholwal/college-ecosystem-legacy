...
const techStack = [
    { name: 'Next.js + Express.js', icon: Globe, description: 'Full-stack architecture' },
    ...
    { name: 'Postgres + MongoDB', icon: Database, description: "Flexible database solutions" }
];

const keyFeatures = [
    { name: 'Lightning Fast', icon: Zap, description: 'Optimized for performance with server-side rendering' },
    { name: 'Scalable Architecture', icon: Code2, description: 'Built to handle thousands of users' },
    { name: 'Open Source', icon: Github, description: 'Community-driven development with transparent codebase' },
]
...
export default function AboutPage({ contributors, stats }: AboutPageProps) {
    ...
    const statsMapping = [
        { icon: Eye, label: 'Visitors', value: 39_443, suffix: '+' },
    ...
    return (
        <div className="min-h-screen bg-background">
            {/* Hero Section */}
            <section ref={heroRef} className="relative overflow-hidden bg-gradient-to-br from-background via-background to-muted/20 py-24 lg:py-32">
                <div className="container mx-auto px-4">
                    ...
                    >
                        ...
                        >
                            <ButtonLink href={appConfig.githubRepo} variant="rainbow" target='_blank' size="lg" effect="expandIcon">
                                <Github />
                                View on GitHub
                    ...
                    >
                        <motion.div variants={fadeInUp} className="text-center mb-12">
                            ...
                            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                                Our growing community continues to drive innovation in educational technology
                            </p>
                        </motion.div>
            ...
            <section ref={techRef} className="py-16 lg:py-24 bg-muted/30">
                <div className="container mx-auto px-4">
                    ...
                    >
                        <motion.div variants={fadeInUp} className="text-center mb-12">
                            <h2 className="text-3xl lg:text-4xl font-bold mb-4">Built for Scale & Performance</h2>
                            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                                Modern architecture designed for reliability, security, and exceptional user experience
                            </p>
                        </motion.div>
            ...
            <section ref={communityRef} className="py-16 lg:py-24">
                <div className="container mx-auto px-4">
                    ...
                    >
                        <motion.div variants={fadeInUp} className="text-center mb-12">
                            <h2 className="text-3xl lg:text-4xl font-bold mb-4">Powered by Community</h2>
                            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                                Meet the talented developers and educators shaping the future of education technology
                            </p>
                        </motion.div>
                                ...
                                {contributors.map((contributor, index) => (
                                    <MagicCard key={index} gradientColor={theme === "dark" ? "#262626" : "#D9D9D955"} layerClassName="bg-card" className="rounded-lg text-center hover:shadow-lg transition-shadow" >
                                        ...
                                        <CardContent className="p-6 text-center">
                                            ...
                                            <Badge variant="default_light">{contributor.contributions} contributions</Badge>
                                        </CardContent>
                                    </MagicCard>
                                ))}
                            </div>
            ...
            <section ref={gettingStartedRef} className="py-16 lg:py-24 bg-muted/30">
                <div className="container mx-auto px-4">
                    ...
                    >
                        <motion.div variants={fadeInUp} className="text-center mb-12">
                            <h2 className="text-3xl lg:text-4xl font-bold mb-4">Get Started Today</h2>
                            <p className="text-lg text-muted-foreground">
                                Join thousands of educators and developers building the future of education
                            </p>
                        </motion.div>
                            ...
                            <motion.div variants={fadeInUp}>
                                <Card className="h-full">
                                    ...
                                    <CardContent className="space-y-4">
                                        <div className="space-y-3">
                                            <div className="flex items-start space-x-3">
                                                ...
                                                <div>
                                                    ...
                                                    <code className="text-sm text-muted-foreground">git clone https://github.com/{appConfig.githubUri}.git</code>
                                                </div>
                                            </div>
                                            <div className="flex items-start space-x-3">
                                        ...
                                        <ButtonLink className="w-full mt-6" href={appConfig.githubRepo} variant="rainbow_outline" target="_blank">
                                            <Github />
                                            View Repository
                                        </ButtonLink>
                                    </CardContent>
                                        ...
                                        <div className="space-y-3">
                                            <div className="flex items-start space-x-3">
                                                ...
                                                <p>
                                                    ...
                                                    <span className="text-muted-foreground"> (use your {orgConfig.mailSuffix} email)</span>
                                                </p>
                                            </div>
                                            <div className="flex items-start space-x-3">
                                                <div className="flex-shrink-0 w-6 h-6 bg-primary text-primary-foreground rounded-full flex items-center justify-center text-sm font-medium">2</div>
                                            ...
                                            <div className="flex items-start space-x-3">
                                                <div className="flex-shrink-0 w-6 h-6 bg-primary text-primary-foreground rounded-full flex items-center justify-center text-sm font-medium">3</div>
                                                <p>
                                                    Explore the platform and join communities
                                                </p>
                                            </div>
                                        </div>
                        ...
                        <motion.div variants={fadeInUp} className="mt-12 text-center" whileHover={scaleOnHover}>
